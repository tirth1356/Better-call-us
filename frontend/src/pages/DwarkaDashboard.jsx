...
const SECTORS = [
  ...
  { name: "Gate 1", risk: "MEDIUM", window: "38m", density: 2.4 },
  { name: "Gate 2", risk: "LOW", window: "90m+", density: 1.1 },
];
...
export default function DwarkaDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#FFF8F0] font-body text-[#4B2E2B]">
      <DashboardNav templeName="Dwarka Temple" />
      <AlertModal />
        ...
        >
          ...
          <motion.div variants={itemVariants} className="mb-8">
            <div className="flex items-center gap-2 mb-1">
              ...
              <p className="text-[10px] font-bold tracking-[0.25em] uppercase text-[#4B2E2B]/40">Site ID: GJ-018 · Gujarat, India</p>
            </div>
            <h2 className="text-3xl font-headline font-black text-[#4B2E2B] tracking-tight">
              Dwarka <span className="text-[#C08552]">Observatory</span>
            </h2>
            <p className="text-sm text-[#4B2E2B]/50 mt-1 max-w-lg">
              Advanced coastal surge and pilgrim inflow modeling.
            </p>
          </motion.div>
